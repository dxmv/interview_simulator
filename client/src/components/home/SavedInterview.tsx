...
import { deleteInterview as deleteInterviewApi } from "../../services/interviewServiceApi";
const SavedInterview = ({ interview }: { interview: SavedInterviewType }) => {
    const deleteInterview = async () => {
        try {
            const response = await deleteInterviewApi(interview.id);
            if (!response) throw new Error('Failed to delete interview');
